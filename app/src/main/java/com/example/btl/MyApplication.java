...
import static com.example.btl.Constants.MAX_BYTES_PDF;
...
public class MyApplication extends Application {
    ...
    public static void deleteBook(Context context, String bookId, String bookUrl, String bookTitle) {
        ...
        progressDialog.setMessage("Deleteing "+bookTitle+" ");//xoa sach
        progressDialog.show();
        ...
        storageReference.delete()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Log.d(TAG, "onSuccess: Now deleteing into from db");
    ...
    public static void imcrementBookViewCount(String bookId){
    ...
    private static void saveDownloadedBook(Context context, ProgressDialog progressDialog, byte[] bytes, String nameWithExtension, String bookId) {
        ...
        try{
            ...
            Toast.makeText(context, "Saving to download folder", Toast.LENGTH_SHORT).show();
            Log.d(TAG_DOWNLOAD, "saveDownloadedBook: Saving to download folder");
            progressDialog.dismiss();

            imcrementBookDownloadCount(bookId);
    ...
    private static void imcrementBookDownloadCount(String bookId) {
        Log.d(TAG_DOWNLOAD, "incrementBookDownloadCount: Incrementing book download count");
        //buoc 1: lay so luong download truoc day
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Books");
        ref.child(bookId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Log.d(downloadsCount, "onDataChange: download count "+downloadsCount);
                        ...
                        //buoc 2 update tang download vao db
                        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Books");
        ...
        if(firebaseAuth.getCurrentUser()==null){
            ...
            ref.child(firebaseAuth.getUid()).child("Favorites").child(bookId)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(context, "Failed to remove from your favorites due to"+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
